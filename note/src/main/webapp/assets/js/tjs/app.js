...
var App = function () {
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            if(available_height<520)available_height=520;
            ...
            if (height >= ch) {
            	...
            	content.attr('style', 'min-height:' + ch + 'px !important');
            }
        }
    }
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            ...
            if(styleColor$.length){
            	  var href = styleColor$.attr("href");
                  var preFixUrl = href.substring(0,href.lastIndexOf("/")+1);
                  styleColor$.attr("href", preFixUrl + color_ + ".css");
                  if ($.cookie) {                
